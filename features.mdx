...
- Intuitive shortcuts like `ctrl + s` , `ctrl + p` and `ctrl + f`. Check out the complete [list of mappings](/docs/mappings/general) to see more.
...
- Extensible plugin to install LSPs via [mason.nvim](https://github.com/williamboman/mason.nvim) and formatters via [null-ls](https://github.com/jose-elias-alvarez/null-ls.nvim) ⚙️
