...
null-ls is a plugin integrated with Better Vim that enables you to format your code
using various formatters. By leveraging null-ls, you can maintain consistent code
...
for null-ls. For example, to install the `blade_formatter` formatter, your
...
<Note>
You can find all formatters for null-ls following <a href='https://github.com/jose-elias-alvarez/null-ls.nvim/blob/main/doc/BUILTINS.md#formatting' target='_blank'>this page</a>
...
Congratulations! You have successfully installed a new formatter using null-ls.
