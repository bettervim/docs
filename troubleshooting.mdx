...
- Or, you can also change the default filters for the file explorer. Please check out the customization section of the file explorer [here](/docs/customization/plugins#nvimtree-options-(file-explorer)).
...
Check this [guide](/docs/mappings/custom-mappings#changing-the-default-leader-key).

### How to create custom mappings

Check this [guide](/docs/mappings/custom-mappings#creating-your-own-mappings).
...
- First, [uninstall Better Vim](/docs/overview/uninstalling)
...
- Now you can [install Better Vim](/docs/overview/installation) again.
